...
data.path <- "/scratch/data/footprints/muscle_organ_hint_20"
#-------------------------------------------------------------------------------
# establish database connections:

if(!exists("db.hint"))
    db.hint <- "muscle_organ_hint_20_localhost"
...
if(!interactive()){    
    ...
    result <- bptry(bplapply(chromosomes,fillAllSamplesByChromosome,
             ...
             fimo = db.fimo,             
             minid = "muscle_organ_hint_20.minid",             
             dbUser = "trena",             
             dbTable = "muscle_organ_hint_20",             
