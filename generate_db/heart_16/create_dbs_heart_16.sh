...
create database heart_wellington_16;
grant all privileges on database heart_wellington_16 to trena;
create database heart_hint_16;
grant all privileges on database heart_hint_16 to trena;
