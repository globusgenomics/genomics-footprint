...
create database kidney_wellington_16;
grant all privileges on database kidney_wellington_16 to trena;
create database kidney_hint_16;
grant all privileges on database kidney_hint_16 to trena;
