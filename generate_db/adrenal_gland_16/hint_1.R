...
data.path <- "/scratch/data/footprints/adrenal_gland_hint_16"
#-------------------------------------------------------------------------------
# establish database connections:

if(!exists("db.hint"))
    db.hint <- "adrenal_gland_hint_16_localhost"
...
if(!interactive()){    
    ...
    result <- bptry(bplapply(chromosomes,fillAllSamplesByChromosome,
             ...
             fimo = db.fimo,             
             minid = "adrenal_gland_hint_16.minid",             
             dbUser = "trena",             
             dbTable = "adrenal_gland_hint_16",             
