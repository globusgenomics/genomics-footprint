...
create database lung_wellington_16;
grant all privileges on database lung_wellington_16 to trena;
create database lung_hint_16;
grant all privileges on database lung_hint_16 to trena;
