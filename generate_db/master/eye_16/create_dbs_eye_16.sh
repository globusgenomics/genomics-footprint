...
create database eye_wellington_16;
grant all privileges on database eye_wellington_16 to trena;
create database eye_hint_16;
grant all privileges on database eye_hint_16 to trena;
