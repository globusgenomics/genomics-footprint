...
#data.path <- "/scratch/data/footprints/eye_wellington_16"
data.path <- "/scratch/shared/footprints/eye_wellington_16"
...
if(!exists("db.wellington"))
    db.wellington <- "eye_wellington_16"
...
if(!interactive()){
    ...
    result <- bptry(bplapply(chromosomes, fillAllSamplesByChromosome,
             ...
             fimo = db.fimo,
             minid = "eye_wellington_16.minid",
             dbUser = "trena",
             dbTable = "eye_wellington_16",
