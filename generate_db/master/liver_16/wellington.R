...
#data.path <- "/scratch/data/footprints/liver_wellington_16"
data.path <- "/scratch/shared/footprints/liver_wellington_16"
...
if(!exists("db.wellington"))
    db.wellington <- "liver_wellington_16"
...
if(!interactive()){
    ...
    result <- bptry(bplapply(chromosomes, fillAllSamplesByChromosome,
             ...
             fimo = db.fimo,
             minid = "liver_wellington_16.minid",
             dbUser = "trena",
             dbTable = "liver_wellington_16",
