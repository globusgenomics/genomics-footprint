...
#data.path <- "/scratch/data/footprints/liver_wellington_20"
data.path <- "/scratch/shared/footprints/liver_wellington_20"
...
if(!exists("db.wellington"))
    db.wellington <- "liver_wellington_20"
...
if(!interactive()){
    ...
    result <- bptry(bplapply(chromosomes, fillAllSamplesByChromosome,
             ...
             fimo = db.fimo,
             minid = "liver_wellington_20.minid",
             dbUser = "trena",
             dbTable = "liver_wellington_20",
