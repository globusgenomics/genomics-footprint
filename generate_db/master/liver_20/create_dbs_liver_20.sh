...
create database liver_wellington_20;
grant all privileges on database liver_wellington_20 to trena;
create database liver_hint_20;
grant all privileges on database liver_hint_20 to trena;
