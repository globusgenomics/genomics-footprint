bddsrds.globusgenomics.org#/bin/bash

psql postgres -U trena -h bddsrds.globusgenomics.org << EOF

create database adrenal_gland_wellington_16;
grant all privileges on database adrenal_gland_wellington_16 to trena;
create database adrenal_gland_hint_16;
grant all privileges on database adrenal_gland_hint_16 to trena;
