...
#data.path <- "/scratch/data/footprints/stomach_wellington_20"
data.path <- "/scratch/shared/footprints/stomach_wellington_20"
...
if(!exists("db.wellington"))
    db.wellington <- "stomach_wellington_20"
...
if(!interactive()){
    ...
    result <- bptry(bplapply(chromosomes, fillAllSamplesByChromosome,
             ...
             fimo = db.fimo,
             minid = "stomach_wellington_20.minid",
             dbUser = "trena",
             dbTable = "stomach_wellington_20",
