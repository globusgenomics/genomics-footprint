...
create database stomach_wellington_20;
grant all privileges on database stomach_wellington_20 to trena;
create database stomach_hint_20;
grant all privileges on database stomach_hint_20 to trena;
