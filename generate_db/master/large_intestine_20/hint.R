...
data.path <- "/scratch/shared/footprints/large_intestine_hint_20"
...
if(!exists("db.wellington"))
    db.wellington <- "large_intestine_hint_20"
...
if(!interactive()){
    ...
    result <- bptry(bplapply(chromosomes,fillAllSamplesByChromosome,
             ...
             fimo = db.fimo,
             minid = "large_intestine_hint_20.minid",
             dbUser = "trena",
             dbTable = "large_intestine_hint_20",
