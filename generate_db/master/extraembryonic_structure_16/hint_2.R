...
data.path <- "/scratch/data/footprints/extraembryonic_structure_hint_16"
#-------------------------------------------------------------------------------
# establish database connections:

if(!exists("db.hint"))
    db.hint <- "extraembryonic_structure_hint_16_localhost"
...
if(!interactive()){    
    ...
    result <- bptry(bplapply(chromosomes,fillAllSamplesByChromosome,
             ...
             fimo = db.fimo,             
             minid = "extraembryonic_structure_hint_16.minid",             
             dbUser = "trena",             
             dbTable = "extraembryonic_structure_hint_16",             
