...
data.path <- "/scratch/data/footprints/extraembryonic_structure_wellington_16"
#-------------------------------------------------------------------------------
# establish database connections:

if(!exists("db.wellington"))
    db.wellington <- "extraembryonic_structure_wellington_16_localhost"
...
if(!interactive()){    
    ...
    result <- bptry(bplapply(chromosomes, fillAllSamplesByChromosome,
             ...
             fimo = db.fimo,
             minid = "extraembryonic_structure_wellington_16.minid",
             dbUser = "trena",
