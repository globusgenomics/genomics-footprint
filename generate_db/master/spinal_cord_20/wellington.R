...
#data.path <- "/scratch/data/footprints/spinal_cord_wellington_20"
data.path <- "/scratch/shared/footprints/spinal_cord_wellington_20"
...
if(!exists("db.wellington"))
    db.wellington <- "spinal_cord_wellington_20"
...
if(!interactive()){
    ...
    result <- bptry(bplapply(chromosomes, fillAllSamplesByChromosome,
             ...
             fimo = db.fimo,
             minid = "spinal_cord_wellington_20.minid",
             dbUser = "trena",
             dbTable = "spinal_cord_wellington_20",
