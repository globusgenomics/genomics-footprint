...
#data.path <- "/scratch/data/footprints/lymphoblast_wellington_16"
data.path <- "/scratch/shared/footprints/lymphoblast_wellington_16"
...
if(!exists("db.wellington"))
    db.wellington <- "lymphoblast_wellington_16"
