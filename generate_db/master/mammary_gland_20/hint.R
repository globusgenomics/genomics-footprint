...
data.path <- "/scratch/shared/footprints/mammary_gland_hint_20"
...
if(!exists("db.wellington"))
    db.wellington <- "mammary_gland_hint_20"
...
if(!interactive()){
    ...
    result <- bptry(bplapply(chromosomes,fillAllSamplesByChromosome,
             ...
             fimo = db.fimo,
             minid = "mammary_gland_hint_20.minid",
             dbUser = "trena",
             dbTable = "mammary_gland_hint_20",
