...
#data.path <- "/scratch/data/footprints/tongue_wellington_16"
data.path <- "/scratch/shared/footprints/tongue_wellington_16"
...
if(!exists("db.wellington"))
    db.wellington <- "tongue_wellington_16"
...
if(!interactive()){
    ...
    result <- bptry(bplapply(chromosomes, fillAllSamplesByChromosome,
             ...
             fimo = db.fimo,
             minid = "tongue_wellington_16.minid",
             dbUser = "trena",
             dbTable = "tongue_wellington_16",
