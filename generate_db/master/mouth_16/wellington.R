...
#data.path <- "/scratch/data/footprints/mouth_wellington_16"
data.path <- "/scratch/shared/footprints/mouth_wellington_16"
...
if(!exists("db.wellington"))
    db.wellington <- "mouth_wellington_16"
...
if(!interactive()){
    ...
    result <- bptry(bplapply(chromosomes, fillAllSamplesByChromosome,
             ...
             fimo = db.fimo,
             minid = "mouth_wellington_16.minid",
             dbUser = "trena",
             dbTable = "mouth_wellington_16",
