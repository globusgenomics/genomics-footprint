...
#data.path <- "/scratch/data/footprints/pancreas_wellington_20"
data.path <- "/scratch/shared/footprints/pancreas_wellington_20"
...
if(!exists("db.wellington"))
    db.wellington <- "pancreas_wellington_20"
...
if(!interactive()){
    ...
    result <- bptry(bplapply(chromosomes, fillAllSamplesByChromosome,
             ...
             fimo = db.fimo,
             minid = "pancreas_wellington_20.minid",
             dbUser = "trena",
             dbTable = "pancreas_wellington_20",
