...
#data.path <- "/scratch/data/footprints/kidney_wellington_16"
data.path <- "/scratch/shared/footprints/kidney_wellington_16"
...
if(!exists("db.wellington"))
    db.wellington <- "kidney_wellington_16"
...
if(!interactive()){
    ...
    result <- bptry(bplapply(chromosomes, fillAllSamplesByChromosome,
             ...
             fimo = db.fimo,
             minid = "kidney_wellington_16.minid",
             dbUser = "trena",
             dbTable = "kidney_wellington_16",
