...
#data.path <- "/scratch/data/footprints/lung_wellington_16"
data.path <- "/scratch/shared/footprints/lung_wellington_16"
...
if(!exists("db.wellington"))
    db.wellington <- "lung_wellington_16"
...
if(!interactive()){
    ...
    result <- bptry(bplapply(chromosomes, fillAllSamplesByChromosome,
             ...
             fimo = db.fimo,
             minid = "lung_wellington_16.minid",
             dbUser = "trena",
             dbTable = "lung_wellington_16",
