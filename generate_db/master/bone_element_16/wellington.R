...
#data.path <- "/scratch/data/footprints/bone_element_wellington_16"
data.path <- "/scratch/shared/footprints/bone_element_wellington_16"
...
if(!exists("db.wellington"))
    db.wellington <- "bone_element_wellington_16"
...
if(!interactive()){
    ...
    result <- bptry(bplapply(chromosomes, fillAllSamplesByChromosome,
             ...
             fimo = db.fimo,
             minid = "bone_element_wellington_16.minid",
             dbUser = "trena",
             dbTable = "bone_element_wellington_16",
