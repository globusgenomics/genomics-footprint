...
#data.path <- "/scratch/data/footprints/heart_wellington_20"
data.path <- "/scratch/shared/footprints/heart_wellington_20"
...
if(!exists("db.wellington"))
    db.wellington <- "heart_wellington_20"
...
if(!interactive()){
    ...
    result <- bptry(bplapply(chromosomes, fillAllSamplesByChromosome,
             ...
             fimo = db.fimo,
             minid = "heart_wellington_20.minid",
             dbUser = "trena",
             dbTable = "heart_wellington_20",
