...
create database lung_wellington_20;
grant all privileges on database lung_wellington_20 to trena;
create database lung_hint_20;
grant all privileges on database lung_hint_20 to trena;
