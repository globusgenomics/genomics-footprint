...
create database tongue_wellington_20;
grant all privileges on database tongue_wellington_20 to trena;
create database tongue_hint_20;
grant all privileges on database tongue_hint_20 to trena;
