...
create database esophagus_wellington_16;
grant all privileges on database esophagus_wellington_16 to trena;
create database esophagus_hint_16;
grant all privileges on database esophagus_hint_16 to trena;
