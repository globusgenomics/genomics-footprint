...
#data.path <- "/scratch/data/footprints/esophagus_wellington_16"
data.path <- "/scratch/shared/footprints/esophagus_wellington_16"
...
if(!exists("db.wellington"))
    db.wellington <- "esophagus_wellington_16"
...
if(!interactive()){
    ...
    result <- bptry(bplapply(chromosomes, fillAllSamplesByChromosome,
             ...
             fimo = db.fimo,
             minid = "esophagus_wellington_16.minid",
             dbUser = "trena",
             dbTable = "esophagus_wellington_16",
