...
create database mouth_wellington_20;
grant all privileges on database mouth_wellington_20 to trena;
create database mouth_hint_20;
grant all privileges on database mouth_hint_20 to trena;
