...
#data.path <- "/scratch/data/footprints/eye_wellington_20"
data.path <- "/scratch/shared/footprints/eye_wellington_20"
...
if(!exists("db.wellington"))
    db.wellington <- "eye_wellington_20"
...
if(!interactive()){
    ...
    result <- bptry(bplapply(chromosomes, fillAllSamplesByChromosome,
             ...
             fimo = db.fimo,
             minid = "eye_wellington_20.minid",
             dbUser = "trena",
             dbTable = "eye_wellington_20",
