...
#data.path <- "/scratch/data/footprints/extraembryonic_structure_wellington_20"
data.path <- "/scratch/shared/footprints/extraembryonic_structure_wellington_20"
...
if(!exists("db.wellington"))
    db.wellington <- "extraembryonic_structure_wellington_20"
...
if(!interactive()){
    ...
    result <- bptry(bplapply(chromosomes, fillAllSamplesByChromosome,
             ...
             fimo = db.fimo,
             minid = "extraembryonic_structure_wellington_20.minid",
             dbUser = "trena",
             dbTable = "extraembryonic_structure_wellington_20",
