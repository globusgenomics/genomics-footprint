...
data.path <- "/scratch/shared/footprints/extraembryonic_structure_hint_20"
...
if(!exists("db.wellington"))
    db.wellington <- "extraembryonic_structure_hint_20"
...
if(!interactive()){
    ...
    result <- bptry(bplapply(chromosomes,fillAllSamplesByChromosome,
             ...
             fimo = db.fimo,
             minid = "extraembryonic_structure_hint_20.minid",
             dbUser = "trena",
             dbTable = "extraembryonic_structure_hint_20",
