...
#data.path <- "/scratch/data/footprints/bronchus_wellington_16"
data.path <- "/scratch/shared/footprints/bronchus_wellington_16"
...
if(!exists("db.wellington"))
    db.wellington <- "bronchus_wellington_16"
...
if(!interactive()){
    ...
    result <- bptry(bplapply(chromosomes, fillAllSamplesByChromosome,
             ...
             fimo = db.fimo,
             minid = "bronchus_wellington_16.minid",
             dbUser = "trena",
             dbTable = "bronchus_wellington_16",
