...
create database bronchus_wellington_16;
grant all privileges on database bronchus_wellington_16 to trena;
create database bronchus_hint_16;
grant all privileges on database bronchus_hint_16 to trena;
