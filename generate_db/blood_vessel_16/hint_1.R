...
data.path <- "/scratch/data/footprints/blood_vessel_hint_16"
#-------------------------------------------------------------------------------
# establish database connections:

if(!exists("db.hint"))
    db.hint <- "blood_vessel_hint_16_localhost"
...
if(!interactive()){    
    ...
    result <- bptry(bplapply(chromosomes,fillAllSamplesByChromosome,
             ...
             fimo = db.fimo,             
             minid = "blood_vessel_hint_16.minid",             
             dbUser = "trena",             
             dbTable = "blood_vessel_hint_16",             
