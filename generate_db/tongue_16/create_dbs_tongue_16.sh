...
create database tongue_wellington_16;
grant all privileges on database tongue_wellington_16 to trena;
create database tongue_hint_16;
grant all privileges on database tongue_hint_16 to trena;
