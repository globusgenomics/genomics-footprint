...
data.path <- "/scratch/data/footprints/pancreas_wellington_16"
#-------------------------------------------------------------------------------
# establish database connections:

if(!exists("db.wellington"))
    db.wellington <- "pancreas_wellington_16_localhost"
...
if(!interactive()){    
    ...
    result <- bptry(bplapply(chromosomes, fillAllSamplesByChromosome,
             ...
             fimo = db.fimo,
             minid = "pancreas_wellington_16.minid",
             dbUser = "trena",
             dbTable = "pancreas_wellington_16",
