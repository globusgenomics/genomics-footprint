...
create database stomach_wellington_16;
grant all privileges on database stomach_wellington_16 to trena;
create database stomach_hint_16;
grant all privileges on database stomach_hint_16 to trena;
