...
create database mouth_wellington_16;
grant all privileges on database mouth_wellington_16 to trena;
create database mouth_hint_16;
grant all privileges on database mouth_hint_16 to trena;
