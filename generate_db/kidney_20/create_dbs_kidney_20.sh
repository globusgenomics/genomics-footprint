...
create database kidney_wellington_20;
grant all privileges on database kidney_wellington_20 to trena;
create database kidney_hint_20;
grant all privileges on database kidney_hint_20 to trena;
