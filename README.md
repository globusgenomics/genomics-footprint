...
- **Followings are the supplementary information that these directories contains workflows and scripts used to generate DNase footprints, TF binding motifs, and databases. Step numbers and dataset numbers follow the convention used in the paper**
